...
\include{\settingsDirectory/math}
...
\include{\tikzDirectory/libraries}
\include{\tikzDirectory/point}
\include{\tikzDirectory/pointAndLabel}
\include{\tikzDirectory/randomVertices}
\include{\tikzDirectory/arcs}
