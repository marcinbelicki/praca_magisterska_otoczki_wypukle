...
%    as first chapter
   ...
   \chapter{Implementacja w języku Scala}
   		...
   		Metoda \lstinline[language=scala]{distanceFromCenterSquared(p: Point): Double} wyznacza kwadrat odległości wskazanego punktu od środka układu współrzędnych.
   		
   		Na podstawie wyżej wymienionej metody zostały zaimplementowane dwie metody związane z odległością między punktami.
